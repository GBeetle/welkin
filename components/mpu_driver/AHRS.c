...
void imuTransformVectorBodyToEarth(float_axes_t *v)
{
...
void imuTransformVectorEarthToBody(float_axes_t *v)
{
    v->y = -v->y;
...
{
	uint8_t useMag = (mag.x != 0) || (mag.y != 0) || (mag.z != 0);
